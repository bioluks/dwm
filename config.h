...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_Escape, spawn,          {.v = shutdowncmd} }, /* Shutdown the Computer */
	{ 0,                       XF86XK_MonBrightnessUp, spawn,  {.v = brightup } }, /* Increase the screen brightness by %5 */
	{ 0,                       XF86XK_MonBrightnessDown, spawn,{.v = brightdown } }, /* Decrease the screen brightness by %5 */
	{ MODKEY,                       XK_w,      spawn,          SHCMD("librewolf") }, /* Launch the browser */
	{ 0,                       XF86XK_Explorer,      spawn,    SHCMD("pcmanfm") }, /* Open File Manager */
	/* { 0,                       XF86XK_AudioLowerVolume, spawn, {.v = downvol } }, */
	/* { 0,                       XF86XK_AudioMute, spawn,        {.v = mutevol } }, */
	/* { 0,                       XF86XK_AudioRaiseVolume, spawn, {.v = upvol } }, */
	/* { 0,                       XF86XK_AudioMicMute, spawn,     {.v = mutemic } }, */
	{ 0,                       XF86XK_AudioLowerVolume, spawn, SHCMD("pamixer --allow-boost -d 5; kill -44 $(pidof dwmblocks)") }, /* Decrease Volume by %5 */
	{ 0,                       XF86XK_AudioMute, spawn,        SHCMD("pamixer --toggle-mute; kill -44 $(pidof dwmblocks)") }, /* Toggle Mute */
	{ 0,                       XF86XK_AudioRaiseVolume, spawn, SHCMD("pamixer --allow-boost -i 5; kill -44 $(pidof dwmblocks)") }, /* Increase volume by %5 */
	{ 0,                       XF86XK_AudioMicMute, spawn,     SHCMD("pamixer --default-source --toggle-mute; kill -44 $(pidof dwmblocks)") }, /* Toggle Mute Microphone */
	{ MODKEY,                       XK_gbreve, spawn,          SHCMD("slock") }, /* Lock screen */
	{ MODKEY,                       XK_udiaeresis, spawn,      SHCMD("touchpadtoggle") }, /* Touchpad toggle */
	{ 0,                       XF86XK_Search, spawn,           SHCMD("rofi -show run")}, /* Run Rofi */
	{ MODKEY|ShiftMask,        XF86XK_Search, spawn,           SHCMD("bwmenu")}, /* Execute the Bitwarden-CLI rofi plugin (you need a working and configured bitwarden-cli locally for this to work) */
	{ MODKEY|ShiftMask,        XK_End, spawn,                  SHCMD("loginctl suspend && slock")}, /* Suspend to RAM and lock screen */
